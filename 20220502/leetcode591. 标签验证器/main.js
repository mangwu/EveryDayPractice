 ...
 * @Author: mangwu                                                             *
 * @File: main.js                                                              *
 * @Date: 2022-05-02 18:33:11                                                  *
 * @LastModifiedDate: 2022-05-03 04:05:16                                      *
 * @ModifiedBy: mangwu                                                         *
 * -----------------------                                                     *
...
// 2.闭合标签（不一定合法）要严格符合格式：<TAG_NAME>TAG_CONTENT</TAG_NAME>。
...
// 4.合法的 TAG_CONTENT 可以包含其他合法的闭合标签，
// cdata （请参考规则7）和任意字符（注意参考规则1）除了不匹配的<、不匹配的起始和结束标签、不匹配的或带有不合法 TAG_NAME 的闭合标签。
// 否则，TAG_CONTENT 是不合法的。
// 5.一个起始标签，如果没有具有相同 TAG_NAME 的结束标签与之匹配，是不合法的。
